function data = psychsr_predictGratings_extra(orient)
...
if stim_switch==1
    ...
    uisave('data',sprintf('%s/%4d%02d%02d_predictGrating_extra_%02d%02d%02d',folder,date(1),date(2),date(3),date(4),date(5),round(date(6))));
end