function mapOrientations_Axonal %<<
...
%% Set stim parameters....................................................
     N = GenerateCombinations_Axonal_Ori; %<<
...
Params.MovsperTrial  = 80; %80 for normal; %85 for interleave ps; 60 for rabies
...
if exist( ['../' date ['/Orientation Tuning' name '/'] ] ) <7
    mkdir( ['../' date ['/Orientation Tuning' name '/'] ] )
end; 
savePath = ['../' date ['/Orientation Tuning' name '/'] ];
fprintf('..... Done!\n');
