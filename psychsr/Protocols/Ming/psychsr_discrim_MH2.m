function data = psychsr_discrim_MH2()
%% TRIAL STRUCTURE
% delay --> response --> iti
...
response.feedback_fn = @psychsr_discrim_feedback_MH2;
...
%         
%         response.grace_period = 0;   % was time during grating that licks don't matter
%         resp_delays = [2 2]; % delay period;
%         response.lick_threshold = 3;
%         
%         iti = 4; %3.5
%         ntarget = 100; %250
%         response.extend_iti = 0;
...
%% save
date = clock;
folder = sprintf('C:/Dropbox/Ming/behaviorData/mouse %04d',mouse);
