...
%% Set stim parameters....................................................
N = GenerateCombinations_Axonal_SpatFreqs; %<<
...
if exist( ['../' date ['/OrientationSpat Tuning' name '/'] ] ) <7
    mkdir( ['../' date ['/OrientationSpat Tuning' name '/'] ] )
end;
savePath = ['../' date ['/OrientationSpat Tuning' name '/'] ];
fprintf('..... Done!\n');
