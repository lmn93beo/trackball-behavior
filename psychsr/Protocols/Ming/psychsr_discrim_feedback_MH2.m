function new_loop = psychsr_discrim_feedback_MH2(loop)
global data;
...
if data.response.auto_reward ~= 0 && psychsr_timed_event(loop,3,data.stimuli.response_delay(loop.stim))
