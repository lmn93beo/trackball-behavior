...
response.feedback_fn = @psychsr_OB_NM_feedback;
presentation.frame_rate = 30;
presentation.lag = 0;
blackblank = 0;                 % blank screen is black or gray?

spat_freq = 0.08;               % spatial frequency in cpd
...
response.response_time = 2.5;   % was response window=StimuliTime+responseWindow
...
switch mouse
    ...
    case 0002
        ...
        response.auto_reward = 0;
        %response.auto_reward_time = 3.5;
        blockmins = 10;  %%% total session time?
        per_high = 0.5;
        data.params.perNoReward = 0;
...
if strcmp(getenv('computername'),'VISSTIM-2P4')
    ...
    if mode > 0
        ...
        total_duration = (blockmins)*60+iti;  %% in seconds
