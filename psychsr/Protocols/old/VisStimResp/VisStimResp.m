...
function data = VisStimResp(stimresp, stimtype)
...
ifi = 1/60;%Screen('GetFlipInterval', win, 100, 0.0001, 20); % should be 8.3ms (120Hz)
...
ichan = addchannel(ai,1:2);

% test using sound input
...
rParams = struct('ai',ai,'ichan',ichan,'fs',fs,'ao',ao);
