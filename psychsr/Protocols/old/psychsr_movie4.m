function data = psychsr_movie4()
% 1sec delay --> punish and abort
%   continue punishing until stopped licking
% 2sec response
% 5sec ITI
...
free = 2; %  free
response.free_rewards = 1; % max num of rewards

response.blank_time = resp;
response.abort_grace = 0.5;
...
%% stimuli
mfiles = 'C:\Dropbox\MouseAttention\mov184-meercatgroom268.mat';
contrasts = 1;
