function data = psychsr_movie_onescreen()
% Trial structure
...
stimuli = psychsr_zip(num_stimuli,total_duration,stim_type,duration,contrast,movie_file,temp_freq);
