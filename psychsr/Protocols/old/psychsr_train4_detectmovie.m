function data = psychsr_train4_detectmovie()
% Trial structure
...
if input('Save File? (0/1): ')
    ...
    uisave('data',sprintf('%4d%02d%02d_train4_%04d',date(1),date(2),date(3),mouse_num));    
end
end
