...
data.params.earlyAbort = 0;     % abort if move during noMvmtTime
data.params.preCueEarlyAbort = 0;
data.params.responseTime = 20;   % maximum reaction time
data.params.servo = 0;

data.params.rewardDelay = 1;  % time after stimulus offset to drink reward
data.params.punishDelay = 2;    % extra ITI on incorrect/timeout trial1s
