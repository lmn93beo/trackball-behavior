...
%         data.params.reward = 12;
        ...
        %                 data.params.blockSize = [10 20];%[10 20]; % min/max block size
        %                 if rand > 0.5
                            data.params.blockSeq = [1 2 1 2 1 2]; % sequence of blocks  ;[3 1 3 2]
        %                 else
                            data.params.blockSize = 10;
        %                 end
        %
...
data.stimuli.id(1:data.params.numTrials) = 3;
