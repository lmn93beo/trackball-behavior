%%
cd('H:\Dropbox (MIT)\MouseAttention\Matlab\gerald\helpers\Suite2P-master') % start this code in the directory with make_db
make_db;

toolbox_path = 'H:\Dropbox (MIT)\MouseAttention\Matlab\gerald\helpers\Suite2P-master';
...
ops0.RegFileRoot            = 'H:\engagement\suite2p\reg';

ops0.getROIs                = 1;
ops0.getSVDcomps            = 0;
ops0.nSVD                   = 1000; % how many SVD components to keep

ops0.temp_tiff              = 'H:\engagement\suite2p\temp.tiff'; % copy data locally first
ops0.ResultsSavePath        = 'H:\engagement\suite2p\results';
ops0.PhaseCorrelation       = 1; % set to 0 for non-whitened cross-correlation
ops0.SubPixel               = Inf; % 2 is alignment by 0.5 pixel, Inf is the exact number from phase correlation

ops0.showTargetRegistration = 1;
ops0.RootStorage            = 'H:\engagement\suite2p\raw';
ops0.ShowCellMap            = 1;
